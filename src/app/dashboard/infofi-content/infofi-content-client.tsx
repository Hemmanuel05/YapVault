  ...
  return (
    <div className="grid gap-8 lg:grid-cols-2">
      ...
      <div className="space-y-6">
        ...
        {result && (
            <div className="space-y-6">
                <div className={cn("animate-in fade-in-0 slide-in-from-bottom-5 duration-500 delay-200")}>
                    <Card>
                        <CardHeader>
                ...
                <div className={cn("animate-in fade-in-0 slide-in-from-bottom-5 duration-500 delay-300")}>
                 ...
                 <div className={cn("animate-in fade-in-0 slide-in-from-bottom-5 duration-500 delay-400")}>
                    <Card>
                        <CardHeader>
                ...
                {yapResult && (
                  <div className={cn("animate-in fade-in-0 slide-in-from-bottom-5 duration-500 delay-500")}>
                    <Card className="bg-card/50">
                        <CardHeader>
